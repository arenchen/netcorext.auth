                        ...
                        .Select(t => new
                                     {
                                         Disabled = t.Disabled,
                                         Roles = t.Roles
                                                  .Where(t2 => (t2.ExpireDate == null || t2.ExpireDate > DateTimeOffset.UtcNow) && !t2.Role.Disabled)
                                                  .Select(t2 => t2.RoleId)
                                                  .ToArray(),
                                         PermissionConditions = t.PermissionConditions
                                                                 .Where(t2 => (t2.ExpireDate == null || t2.ExpireDate > DateTimeOffset.UtcNow) && (t2.Group == null || groups.Contains(t2.Group)))
